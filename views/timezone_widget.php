<div class="col-lg-4 col-md-6">
    ...
    <div class="panel panel-default" id="time-widget">
        ...
        <div class="panel-heading" data-container="body" >
            ...
            <h3 class="panel-title"><i class="fa fa-cog"></i> <span data-i18n="time.timezone_widget.title"></span></h3>
    ...
    $.getJSON( appUrl + '/module/time/get_list', function( data ) {
        ...
        if(data.length){
            $.each(data, function(i,d){
                ...
                box.append('<a href="'+appUrl+'/show/listing/time/time/#'+d.timezone+'" class="list-group-item">'+d.timezone+badge+'</a>')
            });
        }
        else{
