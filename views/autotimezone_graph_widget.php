...
<div class="panel panel-default" id="autotimezone_graph-widget">

    <div class="panel-heading">

        <h3 class="panel-title"><i class="fa fa-globe"></i>
            <span data-i18n="time.autotimezone_widget.title"></span>
...
$(document).on('appReady', function(e, lang) {
    ...
    var widget = 'autotimezone_graph-widget' // Widget id
    var svg = '#' + widget + ' svg';
    var chart;

    var drawGraph = function(){
        var url = appUrl + '/module/time/get_autolist' // Url for json
